...
const outOfMemoryPattern = /ERR_WORKER_OUT_OF_MEMORY|cannot enlarge memory|out of memory|bad_alloc|\bOOM\b/i;
...
function deserializeError(serialized) {
	...
	const diagnostic = serialized?.diagnostic?.trim();
	const cause = diagnostic ? new Error(diagnostic) : undefined;
